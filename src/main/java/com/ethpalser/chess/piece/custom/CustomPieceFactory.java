...
public class CustomPieceFactory implements PieceFactory {
    ...
    private ConditionalOptions conditionTargetNotMoved(Reference reference) {
        return ConditionalOptions.pieceState(reference, PropertyType.HAS_MOVED, Operator.FALSE, false);
    }

    private ConditionalOptions conditionTargetIsRook(Reference reference) {
        return ConditionalOptions.pieceState(reference, PropertyType.CODE, Operator.EQUAL, PieceType.ROOK.toCode());
    }

    private ConditionalOptions conditionPathIsEmpty(Reference start, Reference end) {
    ...
    private ConditionalOptions conditionLastMovedIsPawn() {
        return ConditionalOptions.pieceState(new Reference(Reference.Location.LAST_MOVED, Direction.AT),
                PropertyType.CODE, Operator.EQUAL, PieceType.PAWN.toCode());
    }
    ...
    private ConditionalOptions conditionLastMovedIsAtDirection(Direction direction) {
        return ConditionalOptions.pieceCompare(new Reference(Reference.Location.LAST_MOVED, Direction.AT),
                Operator.EQUAL, new Reference(Reference.Location.POINT, direction));
    }
    ...
    private CustomPiece king(Colour colour, Coordinate coordinate) {
        ...
        MoveSpec castleQueen = (new MoveSpec.Builder(new PathOptions(
                new Reference(Reference.Location.POINT, Direction.RIGHT, 2, Point.ORIGIN)
        )))
                .isAttack(false)
                .isMirrorXAxis(false)
                .isMirrorYAxis(true)
                ...
                .conditions(List.of(
                        ...
                        this.conditionTargetNotMoved(new Reference(Reference.Location.WEST_EDGE, Direction.AT)),
                        this.conditionTargetIsRook(new Reference(Reference.Location.WEST_EDGE, Direction.AT)),
                ...
                .followUp(
                        ...
                        new PathOptions(new Reference(Reference.Location.POINT, Direction.LEFT)) // Left of original
                )
                .build();
        // endregion
        ...
        MoveSpec castleKing = (new MoveSpec.Builder(new PathOptions(
                new Reference(Reference.Location.POINT, Direction.RIGHT, 2, Point.ORIGIN)
        )))
                .isAttack(false)
                .isMirrorXAxis(false)
                ...
                .conditions(List.of(
                        this.conditionSelfNotMoved(),
                        this.conditionTargetNotMoved(new Reference(Reference.Location.EAST_EDGE, Direction.AT)),
                        this.conditionTargetIsRook(new Reference(Reference.Location.EAST_EDGE, Direction.AT)),
                        this.conditionPathIsEmpty(
                ...
                .followUp(
                        ...
                        new PathOptions(new Reference(Reference.Location.POINT, Direction.RIGHT)) // right of original
                )
                .build();
        // endregion
    ...
    private CustomPiece pawn(Colour colour, Coordinate coordinate) {
        MoveSpec moveOne = new MoveSpec.Builder(new PathOptions(new Point(0, 1)))
                .isMirrorXAxis(false)
                .isMirrorYAxis(false)
                .isSpecificQuadrant(true)
                .isAttack(false)
        ...
        MoveSpec moveTwo = new MoveSpec.Builder(new PathOptions(new Point(0, 1), new Point(0, 2)))
                .isMirrorXAxis(false)
                .isMirrorYAxis(false)
                .isSpecificQuadrant(true)
                .isAttack(false)
        ...
        MoveSpec epRight = new MoveSpec.Builder(new PathOptions(new Point(1, 1)))
                .isMirrorXAxis(false)
                .isMirrorYAxis(false)
                .isSpecificQuadrant(true)
                .isAttack(false)
        ...
        MoveSpec epLeft = new MoveSpec.Builder(new PathOptions(new Point(1, 1)))
                .isMirrorXAxis(false)
                .isMirrorYAxis(true)
                .isSpecificQuadrant(true)
                .isAttack(false)
